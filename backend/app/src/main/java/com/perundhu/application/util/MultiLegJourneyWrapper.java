 ...
 * 
 * Output:
 * - Bus 12A: journeyId="broadway_kilambakkam_madurai_12a_25b", legNumber=1,
 * totalLegs=2
 * - Bus 25B: journeyId="broadway_kilambakkam_madurai_12a_25b", legNumber=2,
 * totalLegs=2, intermediateLocationId=62571
 */
public class MultiLegJourneyWrapper {
     ...
     * @param finalDestinationId The user's final destination ID (used to group
     *                           journeys)
     ...
     * @param maxMinutesBetween       Maximum minutes between arrival and next
     *                                departure (flexible)
