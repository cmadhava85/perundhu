...
public interface OCRService {
     ...
     */
    String extractTextFromImage(FileUpload imageFile);
     ...
     */
    boolean isValidBusScheduleImage(FileUpload imageFile);

    /**
     * Get confidence score for OCR extraction
     */
    double getExtractionConfidence(FileUpload imageFile);
