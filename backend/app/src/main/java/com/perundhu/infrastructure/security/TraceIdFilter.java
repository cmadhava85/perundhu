 ...
 * The traceId is added to MDC (Mapped Diagnostic Context) and included in all log entries.
 * 
 * Features:
 * - Generates unique traceId for each request
 * - Respects existing X-Trace-Id or X-Request-Id headers (for distributed systems)
