...
/**
 * Legacy REST controller for admin operations.
 * 
 * @deprecated This controller violates Single Responsibility Principle.
 * Use the new focused controllers instead:
 *   - {@link RouteAdminController} for route admin operations
 *   - {@link ImageAdminController} for image admin operations
 *   - {@link SocialMediaAdminController} for social media operations
 *   - {@link ContributionReprocessingController} for reprocessing operations
 * 
...
public class AdminControllerLegacy {
