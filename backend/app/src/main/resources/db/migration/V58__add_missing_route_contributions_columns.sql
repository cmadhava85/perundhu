...
SET @sql = (SELECT IF(
    (SELECT COUNT(*) FROM INFORMATION_SCHEMA.STATISTICS 
     WHERE table_schema=DATABASE() AND table_name='route_contributions' AND index_name='idx_route_contribution_submitted_by') = 0,
...
SET @sql = (SELECT IF(
    (SELECT COUNT(*) FROM INFORMATION_SCHEMA.STATISTICS 
     WHERE table_schema=DATABASE() AND table_name='route_contributions' AND index_name='idx_route_contribution_submission_date') = 0,
...
SET @sql = (SELECT IF(
    (SELECT COUNT(*) FROM INFORMATION_SCHEMA.STATISTICS 
     WHERE table_schema=DATABASE() AND table_name='route_contributions' AND index_name='idx_route_contribution_source_image') = 0,
...
SET @sql = (SELECT IF(
    (SELECT COUNT(*) FROM INFORMATION_SCHEMA.STATISTICS 
     WHERE table_schema=DATABASE() AND table_name='route_contributions' AND index_name='idx_route_contribution_route_group') = 0,
...
SET @sql = (SELECT IF(
    (SELECT COUNT(*) FROM INFORMATION_SCHEMA.STATISTICS 
     WHERE table_schema=DATABASE() AND table_name='system_settings' AND index_name='setting_key' AND non_unique=0) = 0,
