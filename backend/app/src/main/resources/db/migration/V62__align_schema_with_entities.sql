...
ALTER TABLE announcements
    ...
    MODIFY COLUMN title_fallback VARCHAR(255) NOT NULL,
    MODIFY COLUMN message_key VARCHAR(255) NOT NULL,
    MODIFY COLUMN message_fallback TEXT NOT NULL,
    MODIFY COLUMN unique_id VARCHAR(100) NOT NULL UNIQUE,
    MODIFY COLUMN is_active INT NOT NULL DEFAULT 1,
    MODIFY COLUMN priority INT NOT NULL DEFAULT 5,
    MODIFY COLUMN target_users VARCHAR(50) NOT NULL,
...
ALTER TABLE route_issues
    MODIFY COLUMN issue_type VARCHAR(100) NOT NULL,
...
ALTER TABLE social_media_posts
    MODIFY COLUMN platform VARCHAR(20) NOT NULL;
...
ALTER TABLE image_contributions
    MODIFY COLUMN submission_date DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP;
