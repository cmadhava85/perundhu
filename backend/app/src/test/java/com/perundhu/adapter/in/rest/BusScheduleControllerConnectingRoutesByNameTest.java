...
class BusScheduleControllerConnectingRoutesByNameTest {
    ...
    void connectingRoutesByName_returnsMultipleBusStandOptions() throws Exception {
        ...
        // TODO: Fix this test - method findConnectingRoutesByName does not exist in
        // BusScheduleService
        // when(busScheduleService.findConnectingRoutesByName("Salem - Old Bus Stand",
        // "Madurai", 2, "en"))
        ...
        // .andExpect(jsonPath("$.fromLocations[0].busStandName", is("Salem - Old Bus
        // Stand")))
        // .andExpect(jsonPath("$.fromLocations[1].busStandName", is("Salem - New Bus
        // Stand")))
