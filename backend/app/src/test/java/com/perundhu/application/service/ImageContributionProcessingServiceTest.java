...
class ImageContributionProcessingServiceTest {
    ...
    class RouteCreationTests {
        ...
        void shouldCreateRouteContributionsFromOcrData() {
            ...
            LocationResolutionService.LocationResolution maduraiResolution = 
                LocationResolutionService.LocationResolution.exact("MADURAI", "MADURAI");
            LocationResolutionService.LocationResolution chennaiResolution = 
                LocationResolutionService.LocationResolution.exact("CHENNAI", "CHENNAI");
        ...
        void shouldCreateRoutesWithAutoApproval() {
            ...
            LocationResolutionService.LocationResolution coimbatoreResolution = 
                LocationResolutionService.LocationResolution.exact("COIMBATORE", "COIMBATORE");
            LocationResolutionService.LocationResolution bengaluruResolution = 
                LocationResolutionService.LocationResolution.exact("BENGALURU", "BENGALURU");
        ...
        void shouldExpandRoutesWithMultipleDepartureTimes() {
            ...
            LocationResolutionService.LocationResolution sivakasiResolution = 
                LocationResolutionService.LocationResolution.exact("SIVAKASI", "SIVAKASI");
            LocationResolutionService.LocationResolution maduraiResolution = 
                LocationResolutionService.LocationResolution.exact("MADURAI", "MADURAI");
