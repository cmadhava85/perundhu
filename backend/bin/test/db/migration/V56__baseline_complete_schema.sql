...
CREATE TABLE IF NOT EXISTS route_contributions (
    ...
    KEY idx_route_contribution_submitted_by (submitted_by),
    KEY idx_route_contribution_submission_date (submission_date),
    KEY idx_route_contribution_source_image (source_image_id),
    KEY idx_route_contribution_route_group (route_group_id)
);
