#!/usr/bin/env python3
"""
Create promotional video in LANDSCAPE format (16:9) for YouTube/Desktop
"""
...
def create_video_segment(image_path, audio_path, duration, output_path):
    """Create a video segment from an image and audio in LANDSCAPE format"""
    ...
    # LANDSCAPE FORMAT: 1920x1080 (16:9 ratio)
    cmd = [
        'ffmpeg', '-y',
        '-loop', '1',
        '-i', str(image_path),
        ...
        '-b:a', '192k',
        '-pix_fmt', 'yuv420p',
        # Use desktop screenshots directly (already 1920x1080)
...
def main():
    print("=" * 60)
    print("Creating Perundhu Promotional Video - LANDSCAPE FORMAT")
    print("Format: 1920x1080 (16:9 - YouTube/Desktop)")
    print("=" * 60)
    print()
    ...
    # Concatenate
    final_output = OUTPUT_DIR / "perundhu_promo_landscape.mp4"
    concatenate_videos(segment_paths, final_output)
    
    print()
    print("=" * 60)
    print("✓ LANDSCAPE VIDEO GENERATION COMPLETE!")
    print("=" * 60)
    print(f"Output: {final_output}")
    print(f"Format: 1920x1080 (16:9 Landscape)")
    print(f"Optimized for: YouTube, Facebook, Desktop viewing")
    print()
