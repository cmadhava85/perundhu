...
export BACKEND_IMAGE="${ARTIFACT_REGISTRY}/${GCP_PROJECT_ID}/perundhu-preprod-us/backend:preprod-latest"
export CLOUD_SQL_INSTANCE="astute-strategy-406601:us-central1:perundhu-preprod-mysql-us"
