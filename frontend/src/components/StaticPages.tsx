  ...
  return (
    <div className="static-page">
      ...
      <div className="static-page-container">
        ...
        <section className="content-section">
          <h2>{t('pages.privacy.advertisingTitle', 'Advertising & Cookies')}</h2>
          <p>{t('pages.privacy.advertisingText', 'We use Google AdSense to display advertisements on this site. Google AdSense uses cookies, including the DART cookie, to serve ads based on your visits to this and other websites. You can opt out of the use of the DART cookie by visiting the')}{' '}<a href="https://policies.google.com/technologies/ads" target="_blank" rel="noopener noreferrer">Google Ad and Content Network privacy policy</a>.</p>
          <p>{t('pages.privacy.cookiesText', 'Third-party vendors, including Google, use cookies to serve ads based on your prior visits to our site or other sites on the internet. You may opt out of personalised advertising by visiting')}{' '}<a href="https://www.aboutads.info/choices/" target="_blank" rel="noopener noreferrer">www.aboutads.info/choices</a>{' '}{t('pages.privacy.or', 'or')}{' '}<a href="https://www.networkadvertising.org/managing/opt_out.asp" target="_blank" rel="noopener noreferrer">www.networkadvertising.org</a>.</p>
        </section>
