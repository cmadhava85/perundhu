...
vi.mock('../LoadingSkeleton', () => ({
  LoadingSkeleton: vi.fn(({ count, type }) => (
...
vi.mock('../OpenStreetMapComponent', () => ({
  default: vi.fn(() => <div data-testid="openstreetmap">OSM Map</div>)
}));

vi.mock('../FallbackMapComponent', () => ({
  default: vi.fn(() => <div data-testid="fallback-map">Fallback Map</div>)
}));
...
vi.mock('../contribution/ReportIssue', () => ({
  default: vi.fn(({ onSubmit, onClose }) => (
...
vi.mock('../ConnectingRoutes', () => ({
  default: vi.fn(() => <div data-testid="connecting-routes">Connecting Routes</div>)
}));
